...
class Realsense(object):
    ...
    def __init__(self, camera_configuration_file_path):
        ...
        if self._cfg["name"] == 'L515':
            ...
            config.enable_stream(rs.stream.infrared, 1, self._cfg['depth_infrared']['width'], self._cfg['depth_infrared']['height'], rs.format.y8, self.fps)
            config.enable_stream(rs.stream.infrared, 2, self._cfg['depth_infrared']['width'], self._cfg['depth_infrared']['height'], rs.format.y8, self.fps)
            config.enable_stream(rs.stream.depth, self._cfg['depth_infrared']['width'], self._cfg['depth_infrared']['height'], rs.format.z16, self.fps)
            config.enable_stream(rs.stream.color, self._cfg['color']['width'], self._cfg['color']['height'], rs.format.bgr8, self.fps)
