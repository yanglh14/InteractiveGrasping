...
if __name__ == "__main__":
    ...
    if collect_flag:
        ...
        calib_ins = Calibration(robot, camera, './configs/ICRA2020-ur5-azure-rg6/calib.yaml')
        calib_ins.run()

    if calculate_flag:
        c_t_b = load_calibration_matrix('./configs/ICRA2020-ur5-azure-rg6/calib.npz')
        np.save('./configs/ICRA2020-ur5-azure-rg6/E_T_B.npy', c_t_b)
        print(c_t_b)